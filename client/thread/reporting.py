...
def save_results_to_csv(results: List[Union[StressTestResult, Dict]], output_dir: str = ".", prefix: str = "") -> str:
    """Save test results to CSV file"""
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    csv_path = os.path.join(output_dir, f"{prefix}stress_test_results_{timestamp}.csv")
